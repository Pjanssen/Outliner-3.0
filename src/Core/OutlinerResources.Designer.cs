...
namespace PJanssen.Outliner {
    ...
    internal class OutlinerResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Change light color.
        /// </summary>
        internal static string Command_SetLightColor {
            get {
                return ResourceManager.GetString("Command_SetLightColor", resourceCulture);
            }
        }
